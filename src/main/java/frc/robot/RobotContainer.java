...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        joystick.a().whileTrue(drivetrain.applyRequest(() -> drive.withVelocityX(MaxSpeed * 0.75)));
        joystick.b().whileTrue(drivetrain.applyRequest(() -> drive.withVelocityX(-MaxSpeed * 0.75)));
