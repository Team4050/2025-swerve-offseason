...
public class CalibrateModules extends Command {
  ...
  @Override
  public void execute() {
    double[] rawEncoders = drivetrain.getRawAbsoluteEncoders();
    ...
    SmartDashboard.putString("FL Offset Code", String.format("FL_OFFSET = %.2f;", rawEncoders[0]));
    SmartDashboard.putString("FR Offset Code", String.format("FR_OFFSET = %.2f;", rawEncoders[1]));
    SmartDashboard.putString("BL Offset Code", String.format("BL_OFFSET = %.2f;", rawEncoders[2]));
    SmartDashboard.putString("BR Offset Code", String.format("BR_OFFSET = %.2f;", rawEncoders[3]));
  }
