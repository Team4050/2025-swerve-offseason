...
public class SwerveModule {
  ...
  /** Configure the motors with appropriate settings */
  ...
  public void setDesiredState(SwerveModuleState desiredState) {
    ...
    double steerPositionRotations =
        optimizedState.angle.getRadians() / (2 * Math.PI) * Constants.SwerveModule.STEER_GEAR_RATIO;
  ...
  private double getAbsoluteEncoderRadians() {
    double absolutePositionDegrees = absoluteEncoder.getAbsolutePosition().getValueAsDouble() * 360;
